...
public class Drivetrain extends SubsystemBase implements Loggable {
  ...
  private Drivetrain() {
    ...
    AutoBuilder.configureHolonomic(
      this::getRobotPose2d, // Robot pose supplier
      this::resetGyro, // Method to reset odometry (will be called if your auto has a starting pose)
      this::ChassisSpeeds, // ChassisSpeeds supplier. MUST BE ROBOT RELATIVE
      this::fromFieldRelativeSpeeds, // Method that will drive the robot given ROBOT RELATIVE ChassisSpeeds
