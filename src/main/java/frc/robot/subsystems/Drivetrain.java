...
public class Drivetrain extends SubsystemBase {
  ...
  private static final Translation2d FRONT_LEFT_MODULE_CENTER_OFFSET = new Translation2d(-0.5, 0.5);      // TODO: find actual offsets.
  private static final Translation2d FRONT_RIGHT_MODULE_CENTER_OFFSET = new Translation2d(0.5, 0.5);
  private static final Translation2d BOTTOM_LEFT_MODULE_CENTER_OFFSET = new Translation2d(-0.5, -0.5);
